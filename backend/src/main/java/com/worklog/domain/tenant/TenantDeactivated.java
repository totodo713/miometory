 ...
 */
public record TenantDeactivated(UUID eventId, Instant occurredAt, UUID aggregateId, String reason)
        implements DomainEvent {

    public static TenantDeactivated create(UUID tenantId, String reason) {
        return new TenantDeactivated(UUID.randomUUID(), Instant.now(), tenantId, reason);
    }
