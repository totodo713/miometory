 ...
 */
public record OrganizationActivated(UUID eventId, Instant occurredAt, UUID aggregateId) implements DomainEvent {

    public static OrganizationActivated create(UUID organizationId) {
        return new OrganizationActivated(UUID.randomUUID(), Instant.now(), organizationId);
    }
