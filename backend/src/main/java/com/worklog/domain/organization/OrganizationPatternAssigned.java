...
public record OrganizationPatternAssigned(
        UUID eventId, Instant occurredAt, UUID aggregateId, UUID fiscalYearPatternId, UUID monthlyPeriodPatternId)
        implements DomainEvent {

    public static OrganizationPatternAssigned create(
            UUID organizationId, UUID fiscalYearPatternId, UUID monthlyPeriodPatternId) {
        return new OrganizationPatternAssigned(
                UUID.randomUUID(), Instant.now(), organizationId, fiscalYearPatternId, monthlyPeriodPatternId);
    }
