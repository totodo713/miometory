...
public class OrganizationController {
    ...
    public ResponseEntity<Map<String, Object>> createOrganization(
            @PathVariable UUID tenantId, @RequestBody CreateOrganizationRequest request) {
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<Map<String, Object>> getOrganization(@PathVariable UUID tenantId, @PathVariable UUID id) {
        ...
        response.put(
                ...
                organization.getParentId() != null
                        ? organization.getParentId().value().toString()
                        : null);
    ...
    public ResponseEntity<Void> updateOrganization(
            @PathVariable UUID tenantId, @PathVariable UUID id, @RequestBody UpdateOrganizationRequest request) {
    ...
    public ResponseEntity<Void> deactivateOrganization(@PathVariable UUID tenantId, @PathVariable UUID id) {
    ...
    public ResponseEntity<Void> activateOrganization(@PathVariable UUID tenantId, @PathVariable UUID id) {
    ...
    public ResponseEntity<Map<String, Object>> getDateInfo(
            @PathVariable UUID tenantId, @PathVariable UUID id, @Valid @RequestBody DateInfoRequest request) {
