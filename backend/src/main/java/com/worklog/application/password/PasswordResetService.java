...
public class PasswordResetService {
    ...
    public PasswordResetService(JdbcUserRepository userRepository,
    ...
    public void confirmReset(String token, String newPassword) {
        PasswordResetToken resetToken = tokenRepository.findValidByToken(token)
        ...
        // Userエンティティへのパスワード更新（仮にsetterやwithで）
