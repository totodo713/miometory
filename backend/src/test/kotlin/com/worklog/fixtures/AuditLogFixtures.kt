...
object AuditLogFixtures {
     ...
     */
    fun createLoginSuccessLog(userId: UserId, ipAddress: String = "192.168.1.100", details: String? = null): AuditLog =
        AuditLog(
            UUID.randomUUID(),
            userId,
     ...
     */
    fun createLogoutLog(userId: UserId, ipAddress: String = "192.168.1.100"): AuditLog = AuditLog(
        UUID.randomUUID(),
        userId,
        AuditLog.LOGOUT,
        ipAddress,
     ...
     */
    fun createPasswordChangeLog(userId: UserId, ipAddress: String = "192.168.1.100"): AuditLog = AuditLog(
        UUID.randomUUID(),
        userId,
