...
object UserFixtures {
     ...
     */
    fun validEmail(prefix: String = "user"): String = 
        "${prefix}_${UUID.randomUUID().toString().take(8)}@example.com"
    
    /**
     * Creates a valid user name.
     */
    fun validName(firstName: String = "Test", lastName: String = "User"): String = 
        "$firstName $lastName"
    
    /**
     * Creates a valid bcrypt hashed password (hash of "password123").
     */
    fun validHashedPassword(): String = 
