...
class MemberProjectAssignmentTest {
    ...
    class CreationViaFactoryMethod {
        ...
        void shouldCreateWithUniqueId() {
            MemberProjectAssignment assignment1 =
                    MemberProjectAssignment.create(testTenantId, testMemberId, testProjectId, testAssignedBy);
            MemberProjectAssignment assignment2 =
                    MemberProjectAssignment.create(testTenantId, testMemberId, testProjectId, testAssignedBy);
        ...
        void shouldCreateWithNullAssignedBy() {
            MemberProjectAssignment assignment = MemberProjectAssignment.create(
                    testTenantId, testMemberId, testProjectId, null // assignedBy can be null
                    );
    ...
    class ActivationAndDeactivation {
        ...
        @BeforeEach
        void setUp() {
            assignment = MemberProjectAssignment.create(testTenantId, testMemberId, testProjectId, testAssignedBy);
        }
