...
class MonthlyApprovalTest {
    ...
    void setUp() {
        ...
        fiscalMonth = new FiscalMonthPeriod(LocalDate.of(2026, 1, 21), LocalDate.of(2026, 2, 20));
    ...
    class Creation {
        ...
        void shouldCreateValidApproval() {
            MonthlyApproval approval = MonthlyApproval.create(testMemberId, fiscalMonth);
        ...
        void shouldRejectNullMemberId() {
            assertThrows(NullPointerException.class, () -> MonthlyApproval.create(null, fiscalMonth));
        }

        @Test
        @DisplayName("should reject null fiscal month")
        void shouldRejectNullFiscalMonth() {
            assertThrows(NullPointerException.class, () -> MonthlyApproval.create(testMemberId, null));
        }
    }
    ...
    class Submission {
        ...
        void shouldRejectDoubleSubmission() {
            ...
            assertThrows(DomainException.class, () -> approval.submit(submittedBy, workLogEntryIds, absenceIds));
        }
        ...
        void shouldRejectSubmissionWhenApproved() {
            ...
            assertThrows(DomainException.class, () -> approval.submit(submittedBy, newEntryIds, absenceIds));
        }
        ...
        void shouldRejectNullSubmittedBy() {
            ...
            assertThrows(NullPointerException.class, () -> approval.submit(null, workLogEntryIds, absenceIds));
        }
        ...
        void shouldRejectNullWorkLogEntryIds() {
            ...
            assertThrows(NullPointerException.class, () -> approval.submit(submittedBy, null, absenceIds));
        }
        ...
        void shouldRejectNullAbsenceIds() {
            ...
            assertThrows(NullPointerException.class, () -> approval.submit(submittedBy, workLogEntryIds, null));
        }
    }
    ...
    class Approval {
        ...
        void shouldRejectApprovalIfNotSubmitted() {
            ...
            assertThrows(DomainException.class, () -> approval.approve(reviewedBy));
        }
        ...
        void shouldRejectNullReviewedBy() {
            ...
            assertThrows(NullPointerException.class, () -> approval.approve(null));
        }
    }
    ...
    class Rejection {
        ...
        void shouldRejectRejectionIfNotSubmitted() {
            ...
            assertThrows(DomainException.class, () -> approval.reject(reviewedBy, "Some reason"));
        }
        ...
        void shouldRejectRejectionWhenApproved() {
            ...
            assertThrows(DomainException.class, () -> approval.reject(reviewedBy, "Too late"));
        }
        ...
        void shouldRejectNullReason() {
            ...
            assertThrows(DomainException.class, () -> approval.reject(reviewedBy, null));
        }
        ...
        void shouldRejectEmptyReason() {
            ...
            assertThrows(DomainException.class, () -> approval.reject(reviewedBy, "   "));
        }
        ...
        void shouldRejectLongReason() {
            ...
            assertThrows(DomainException.class, () -> approval.reject(reviewedBy, longReason));
        }
        ...
        void shouldRejectNullReviewedBy() {
            ...
            assertThrows(NullPointerException.class, () -> approval.reject(null, "Some reason"));
        }
    }
