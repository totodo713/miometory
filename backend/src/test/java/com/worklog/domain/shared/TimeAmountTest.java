...
class TimeAmountTest {
    ...
    class CreationAndValidation {
        ...
        void shouldRejectInvalidIncrements(double hours) {
            ...
            assertEquals("Hours must be in 0.25 hour increments (15-minute intervals)", 
    ...
    class EqualityAndToString {
        ...
        void shouldFormatToString() {
            ...
            assertTrue(result.contains("8.5") || result.contains("8.50"), 
                "Should contain 8.5 or 8.50");
        }
