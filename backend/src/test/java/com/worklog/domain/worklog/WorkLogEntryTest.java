...
class WorkLogEntryTest {
    ...
    class Creation {
        ...
        void shouldCreateValidEntry() {
            WorkLogEntry entry =
                    WorkLogEntry.create(testMemberId, testProjectId, testDate, testHours, "Test comment", enteredBy);
        ...
        void shouldCreateWithNullComment() {
            WorkLogEntry entry = WorkLogEntry.create(testMemberId, testProjectId, testDate, testHours, null, enteredBy);
        ...
        void shouldCreateWithEmptyComment() {
            WorkLogEntry entry = WorkLogEntry.create(testMemberId, testProjectId, testDate, testHours, "", enteredBy);
        ...
        void shouldCreateEntryForToday() {
            ...
            WorkLogEntry entry =
                    WorkLogEntry.create(testMemberId, testProjectId, today, testHours, "Today's work", enteredBy);
        ...
        void shouldRejectNullDate() {
            DomainException exception = assertThrows(
                    ...
                    () -> WorkLogEntry.create(testMemberId, testProjectId, null, testHours, "Comment", enteredBy));
        ...
        void shouldRejectFutureDate() {
            ...
            DomainException exception = assertThrows(
                    DomainException.class,
                    () -> WorkLogEntry.create(
                            testMemberId, testProjectId, futureDate, testHours, "Comment", enteredBy));
        ...
        void shouldRejectLongComment() {
            ...
            DomainException exception = assertThrows(
                    DomainException.class,
                    () -> WorkLogEntry.create(
                            testMemberId, testProjectId, testDate, testHours, longComment, enteredBy));
        ...
        void shouldAcceptMaxLengthComment() {
            ...
            WorkLogEntry entry =
                    WorkLogEntry.create(testMemberId, testProjectId, testDate, testHours, maxComment, enteredBy);
    ...
    class Update {
        ...
        void setUp() {
            entry = WorkLogEntry.create(
                    testMemberId, testProjectId, testDate, testHours, "Original comment", enteredBy);
        ...
        void shouldRejectUpdateOfApprovedEntry() {
            ...
            DomainException exception =
                    assertThrows(DomainException.class, () -> entry.update(TimeAmount.of(7.0), "New comment", updater));
        ...
        void shouldRejectLongCommentOnUpdate() {
            ...
            DomainException exception =
                    assertThrows(DomainException.class, () -> entry.update(testHours, longComment, updater));
    ...
    class StatusTransitions {
        ...
        @BeforeEach
        void setUp() {
            entry = WorkLogEntry.create(testMemberId, testProjectId, testDate, testHours, "Test comment", enteredBy);
            entry.clearUncommittedEvents();
        ...
        void shouldRejectDraftToApproved() {
            DomainException exception = assertThrows(
                    DomainException.class, () -> entry.changeStatus(WorkLogStatus.APPROVED, statusChanger));
        ...
        void shouldRejectDraftToRejected() {
            DomainException exception = assertThrows(
                    DomainException.class, () -> entry.changeStatus(WorkLogStatus.REJECTED, statusChanger));
        ...
        void shouldRejectApprovedTransition() {
            ...
            DomainException exception =
                    assertThrows(DomainException.class, () -> entry.changeStatus(WorkLogStatus.DRAFT, statusChanger));
        ...
        void shouldAllowSubmittedToDraft() {
            ...
            assertInstanceOf(
                    WorkLogEntryStatusChanged.class,
                    entry.getUncommittedEvents().get(0));
        }
    ...
    class BusinessRules {
        ...
        void shouldIdentifyDraftAsEditable() {
            WorkLogEntry entry =
                    WorkLogEntry.create(testMemberId, testProjectId, testDate, testHours, "Comment", enteredBy);
        ...
        void shouldIdentifySelfEntry() {
            WorkLogEntry entry = WorkLogEntry.create(
                    testMemberId, testProjectId, testDate, testHours, "Comment", testMemberId // Same as memberId
                    );
