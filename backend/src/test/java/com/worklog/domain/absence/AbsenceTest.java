...
class AbsenceTest {
    ...
    class Recording {
        ...
        void shouldRecordValidAbsence() {
            Absence absence =
                    Absence.record(testMemberId, testDate, testHours, testAbsenceType, testReason, recordedBy);
        ...
        void shouldRecordWithNullReason() {
            Absence absence = Absence.record(testMemberId, testDate, testHours, testAbsenceType, null, recordedBy);
        ...
        void shouldRecordWithEmptyReason() {
            Absence absence = Absence.record(testMemberId, testDate, testHours, testAbsenceType, "", recordedBy);
        ...
        void shouldRecordAbsenceForToday() {
            ...
            Absence absence = Absence.record(testMemberId, today, testHours, testAbsenceType, testReason, recordedBy);
        ...
        void shouldRecordSickLeave() {
            Absence absence =
                    Absence.record(testMemberId, testDate, testHours, AbsenceType.SICK_LEAVE, "Flu", recordedBy);
        ...
        void shouldRecordSpecialLeave() {
            Absence absence = Absence.record(
                    testMemberId, testDate, testHours, AbsenceType.SPECIAL_LEAVE, "Family emergency", recordedBy);
        ...
        void shouldRecordOtherType() {
            Absence absence = Absence.record(
                    testMemberId, testDate, testHours, AbsenceType.OTHER, "Personal reasons", recordedBy);
        ...
        void shouldRejectNullDate() {
            DomainException exception = assertThrows(
                    ...
                    () -> Absence.record(testMemberId, null, testHours, testAbsenceType, testReason, recordedBy));
        ...
        void shouldRejectFutureDate() {
            ...
            DomainException exception = assertThrows(
                    DomainException.class,
                    () -> Absence.record(testMemberId, futureDate, testHours, testAbsenceType, testReason, recordedBy));
        ...
        void shouldRejectLongReason() {
            ...
            DomainException exception = assertThrows(
                    DomainException.class,
                    () -> Absence.record(testMemberId, testDate, testHours, testAbsenceType, longReason, recordedBy));
        ...
        void shouldAcceptMaxLengthReason() {
            ...
            Absence absence = Absence.record(testMemberId, testDate, testHours, testAbsenceType, maxReason, recordedBy);
        ...
        void shouldAcceptQuarterHourIncrements() {
            ...
            Absence absence1 =
                    Absence.record(testMemberId, testDate, quarterHour, testAbsenceType, testReason, recordedBy);
            assertEquals(quarterHour, absence1.getHours());

            Absence absence2 =
                    Absence.record(testMemberId, testDate, halfHour, testAbsenceType, testReason, recordedBy);
            assertEquals(halfHour, absence2.getHours());

            Absence absence3 =
                    Absence.record(testMemberId, testDate, threeQuarters, testAbsenceType, testReason, recordedBy);
    ...
    class Update {
        ...
        @BeforeEach
        void setUp() {
            absence = Absence.record(testMemberId, testDate, testHours, testAbsenceType, testReason, recordedBy);
        ...
        void shouldRejectLongReasonOnUpdate() {
            ...
            DomainException exception = assertThrows(
                    DomainException.class, () -> absence.update(testHours, testAbsenceType, longReason, updater));
    ...
    class StatusTransitions {
        ...
        void shouldRejectDraftToApproved() {
            DomainException exception = assertThrows(
                    DomainException.class, () -> absence.changeStatus(AbsenceStatus.APPROVED, statusChanger));
        ...
        void shouldRejectDraftToRejected() {
            DomainException exception = assertThrows(
                    DomainException.class, () -> absence.changeStatus(AbsenceStatus.REJECTED, statusChanger));
        ...
        void shouldRejectApprovedTransition() {
            ...
            DomainException exception =
                    assertThrows(DomainException.class, () -> absence.changeStatus(AbsenceStatus.DRAFT, statusChanger));
        ...
        void shouldAllowSubmittedToDraft() {
            ...
            assertInstanceOf(
                    AbsenceStatusChanged.class, absence.getUncommittedEvents().get(0));
        }
    ...
    class Deletion {
        ...
        void shouldRejectDeleteOfSubmittedAbsence() {
            ...
            DomainException exception = assertThrows(DomainException.class, () -> absence.delete(deleter));
